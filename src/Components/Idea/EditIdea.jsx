...
const EditIdea = () => {
    ...
    const [setcover, setSCVideo] = useState(false)
    const [setdoc, setSetDoc] = useState(false)
    ...
    useEffect(() => {
        const SetDefaultValues = async () => {
            if (get) {
                ...
                setTotCost(idea.total_investment)
                setTimeMonth(idea.time_to_finish)
                setCostEquipment(idea.equipment_cost)
                setConsumCost(idea.used_equipment_cost)
                setHumanCost(idea.hr_cost)
                setOtherCost(idea.other_cost)
                setDescription_1(idea.fianancial_summary)
                setSoldCostForiegn(idea.foreign_sold_unit)
                setIncomeForeign(idea.foreign_income)
                setSoldCostDomestic(idea.demostic_sold_unit)
                setIncomeDomestic(idea.demostic_income)
                setDescription_2(idea.description)
                fetch(idea.image, {
                    method: 'GET',
                })
                            ...
                            <Accordion
                                ...
                                <AccordionBody>
                                    {fvideo &&
                                        <li>
                                            <div className=" px-10 py-10 border-spacing-3 border border-dashed   justify-between flex">
                                                <button className="" onClick={() => { setFVideo(); setSetVideo(true) }}> delete</button>
                            ...
                            <Accordion
                                ...
                                <AccordionBody>
                                    {cvideo &&
                                        <li>
                                            <div className=" px-10 py-10 border-spacing-3 border border-dashed   justify-between flex">
                                                <button className="" onClick={() => { setCVideo(); setSCVideo(true) }}> delete</button>
                                                <video className="w-[50%]  rounded-2xl" controls  >
                            ...
                            <Accordion
                                ...
                                <AccordionBody>
                                    ...
                                    {!setdoc &&
                                        <li>
                                            <div className=" px-8 py-10 border-spacing-3 border border-dashed   justify-between flex">
                                                <button className="" onClick={() => { setDoc(); setSetDoc(true) }}> delete</button>
                                                <div className=" flex flex-col items-center gap-y-2">
                                                    <FaRegFilePdf size={60} />
                        ...
                        <div className=" py-5 px-5 flex flex-col justify-center items-center ">
                            <button className="" onClick={handeleditIdea} >
                                <div className=" bg-accent-100 hover:bg-primary-100 hover:text-bg-100 hover:font-bold w-[100%] sm:w-[450px] pt-3 pb-3 flex rounded-[8px] flex-col items-center gap-2">
                                    <div className="">
                                        <span className="font-main text-[18px]">ویرایش کردن</span>
                                    </div>
                                </div>
                            </button>
                        </div>
